    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fullname', models.CharField(max_length=100, validators=[core.validators.FullNameValidator()])),
                ('phone_number', models.CharField(max_length=10, unique=True, validators=[core.validators.PhoneNumberValidator()])),
